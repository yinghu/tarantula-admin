...
function query_topic(topic,payload,token,callback){
    const headers = {'Authorization' : `Bearer ${token}`};
    const path = `admin/cs/query/topic/${topic}`;
...
function QueryTopic(){
    ...
    const query =()=>{
        ...
        query_topic(topic,exp,token,(resp)=>{
    ...
    return(
        <div>
            ...
            <fieldset className="border-2 border-gray-200">
                <legend className="m-2">Topic</legend>
                    <div className="m-4">
